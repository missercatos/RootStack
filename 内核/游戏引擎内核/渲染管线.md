...
- [[../../c语言教程/2深化/01_指针深度剖析|C 指针]] -- 顶点数据指针操作
- [[../../c语言教程/2深化/03_动态内存管理|C 动态内存]] -- GPU 资源分配与释放
- [[../../cpp教程/cpp深化教程/05_面向对象(一)类与对象基础|C++ 类与对象]] -- 场景图节点类层次
- [[../../cpp教程/cpp深化教程/13_多线程|C++ 多线程]] -- 渲染线程分离
- [[../../数据结构/I_树_Tree_BST_AVL|树结构]] -- 场景图的树形组织
- [[../../数据结构/A_容器_Container|容器]] -- VBO/IBO 的数据组织
- [[../系统内核/04_设备驱动|设备驱动]] -- GPU 驱动的用户态接口
- [[游戏循环]] -- 渲染管线的调度入口
- [[物理引擎]] -- 物理世界与渲染的分离
- [[Chromium渲染内核]] -- 浏览器渲染与光栅渲染的异同
