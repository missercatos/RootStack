...
- [[../../c语言教程/2深化/01_指针深度剖析|C 指针]] -- Collider 数据布局
- [[../../c语言教程/2深化/03_动态内存管理|C 动态内存]] -- BVH 节点池
- [[../../cpp教程/cpp深化教程/07_面向对象(三)多态与虚函数|C++ 虚函数]] -- Collider 多态
- [[../../cpp教程/cpp深化教程/13_多线程|C++ 多线程]] -- 多线程物理求解
- [[../../数据结构/I_树_Tree_BST_AVL|树结构]] -- BVH 树结构
- [[../../数据结构/A_容器_Container|容器]] -- 碰撞对缓存
- [[../../算法/算法技巧/动态规划|动态规划]] -- 约束求解的迭代方法
- [[../系统内核/06_并发与同步|并发与同步]] -- 物理线程同步
- [[游戏循环]] -- 固定时间步长的物理循环
- [[渲染管线]] -- 物理世界到渲染世界的同步
