...
- [[../../c语言教程/2深化/02_内存模型与布局|C 内存模型]] -- SoA 布局的缓存原理
- [[../../c语言教程/2深化/07_面向对象C编程|C 实现 OOP]] -- 对比: 接口 vs ECS
- [[../../cpp教程/cpp深化教程/05_面向对象(一)类与对象基础|C++ OOP]] -- 对比: 继承 vs ECS
- [[../../cpp教程/cpp深化教程/07_面向对象(三)多态与虚函数|C++ 虚函数]] -- vtable 开销 vs none
- [[../../cpp教程/cpp深化教程/13_多线程|C++ 多线程]] -- System 的并行执行
- [[../../数据结构/A_容器_Container|容器]] -- Sparse Set 的实现
- [[../../数据结构/G_哈希表_HashTable|哈希表]] -- Entity-Component 映射
- [[../../数据结构/D_链表_LinkedList|链表]] -- 对比: 链表 vs 连续数组
- [[../系统内核/02_进程与内存管理|进程与内存管理]] -- 内存页对齐
- [[游戏循环]] -- System 的遍历调度
- [[渲染管线]] -- RenderSystem 的 GPU 交互
