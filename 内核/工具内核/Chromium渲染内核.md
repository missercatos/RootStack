...
- [[../../c语言教程/2深化/01_指针深度剖析|C 指针]] -- DOM 树的 C++ 指针运用
- [[../../c语言教程/2深化/03_动态内存管理|C 动态内存]] -- 渲染对象池化
- [[../../cpp教程/cpp深化教程/05_面向对象(一)类与对象基础|C++ 类与对象]] -- DOM 树的多态继承树
- [[../../cpp教程/cpp深化教程/07_面向对象(三)多态与虚函数|C++ 虚函数]] -- vtable 源码级运用
- [[../../数据结构/I_树_Tree_BST_AVL|树结构]] -- DOM 树、Layout 树、Paint 树
- [[../系统内核/03_文件系统|文件系统]] -- 渲染对象生命周期 vs 文件生命周期
- [[V8|V8 引擎]] -- JS 执行与渲染引擎的协作
- [[游戏循环]] -- 浏览器的帧循环 vs 游戏循环
- [[渲染管线]] -- GPU 渲染管线与浏览器合成的异同
