...
- [[../../c语言教程/2深化/01_指针深度剖析|C 指针]] -- ngx_connection_t 指针池
- [[../../c语言教程/2深化/04_函数指针与回调|C 函数指针]] -- 事件回调 handler
- [[../../c语言教程/2深化/07_面向对象C编程|C 实现 OOP]] -- Nginx 模块接口是 C OOP 典范
- [[../../c语言教程/2深化/03_动态内存管理|C 动态内存]] -- pool allocator (ngx_pool_t)
- [[../../cpp教程/cpp深化教程/13_多线程|C++ 多线程]] -- 对比: 多线程 vs epoll
- [[../../数据结构/F_队列_Queue|队列]] -- 连接队列管理
- [[../../数据结构/A_容器_Container|容器]] -- 数组池化
- [[../系统内核/03_文件系统|文件系统]] -- sendfile 零拷贝
- [[../系统内核/06_并发与同步|并发与同步]] -- shared memory + lock
- [[Redis内核|Redis 内核]] -- 对比: ae 事件循环 vs Nginx 事件循环
