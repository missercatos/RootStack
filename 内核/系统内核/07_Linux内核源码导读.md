...
**前置要求**：
- 已完成前六章的学习（01-06）
- 已学完 [[../2深化/07_面向对象C编程|面向对象C编程]]（理解 C 实现抽象/多态的模式）
- 已学完 [[../3数据结构/02_链表|链表]]（理解内核链表的外链式设计）
- 已学完 [[../2深化/06_编译链接与ELF|编译链接与ELF]]（理解符号和编译过程）
...
//   - 项目讨论用 Rust 重写关键安全代码
//   - 详见 [[../Rust教程/6内核/01-Linux内核Rust支持概述]]
```
...
//
// 详见:
//   - [[../Rust教程/6内核/01-Linux内核Rust支持概述|Rust: 内核Rust支持概述]]
//   - [[../Rust教程/6内核/02-内核Rust抽象层|Rust: 内核Rust抽象层]]
//   - [[../Rust教程/6内核/04-内核驱动：Rust vs C对比|Rust: Rust vs C驱动对比]]
//   - [[../Rust教程/6内核/05-参与内核Rust开发|Rust: 参与内核Rust开发]]
//   - [[../Rust教程/6内核/06-内核Rust未来展望|Rust: 内核Rust未来]]
```
...
> **难度**: 
>
> 将 [[../3数据结构/02_链表|链表章节]] 中手动实现的链表改为使用内核的 list.h：
...
- **上一章**: [[06_并发与同步|并发与同步]]
- **返回**: [[../目录|目录]]
- **相关**: [[../2深化/07_面向对象C编程|面向对象C编程]] | [[../2深化/06_编译链接与ELF|编译链接与ELF]] | [[../3数据结构/02_链表|链表]]
- **汇编参考**: [[../../ASM教程/07_编译原理|ASM: 编译原理]]
- **Rust 延伸**: [[../../Rust教程/6内核/01-Linux内核Rust支持概述|Rust: 内核Rust支持概述]] | [[../../Rust教程/6内核/05-参与内核Rust开发|Rust: 参与内核Rust开发]] | [[../../Rust教程/6内核/06-内核Rust未来展望|Rust: 内核Rust未来展望]]
