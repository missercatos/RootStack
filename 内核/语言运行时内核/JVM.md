...
- [[../../cpp教程/cpp深化教程/05_面向对象(一)类与对象基础|C++ 类与对象]] -- HotSpot 用 C++ 实现
- [[../../cpp教程/cpp深化教程/07_面向对象(三)多态与虚函数|C++ 虚函数]] -- klass vtable vs C++ vtable
- [[../../cpp教程/cpp深化教程/13_多线程|C++ 多线程]] -- Java 线程映射到 OS 线程
- [[../../数据结构/G_哈希表_HashTable|哈希表]] -- Java HashMap
- [[../../数据结构/E_红黑树_RedBlackTree|红黑树]] -- Java TreeMap
- [[../../数据结构/O_B树_BTree|B-Tree]] -- 对比数据库索引
- [[../系统内核/06_并发与同步|并发与同步]] -- JVM 的锁膨胀: 偏向锁 → 轻量级锁 → 重量级锁
- [[CPython|CPython 运行时]] -- 对比 GIL vs 真正多线程
- [[V8|V8 引擎]] -- 对比隐藏类 vs klass pointer
- [[JIT编译原理|JIT 编译原理]] -- 详细 JIT 机制
- [[垃圾回收算法|垃圾回收算法]] -- 详细 GC 算法对比
