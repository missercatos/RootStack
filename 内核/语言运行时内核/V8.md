...
- [[../../cpp教程/cpp深化教程/05_面向对象(一)类与对象基础|C++ 类与对象]] -- V8 用 C++ 实现
- [[../../cpp教程/cpp深化教程/07_面向对象(三)多态与虚函数|C++ 虚函数]] -- 隐藏类 vs vtable
- [[../../cpp教程/cpp深化教程/13_多线程|C++ 多线程]] -- Isolate 的线程模型
- [[../../数据结构/G_哈希表_HashTable|哈希表]] -- JS 对象内部就是哈希表
- [[../系统内核/06_并发与同步|并发与同步]] -- libuv 的事件循环相当于用户态"调度器"
- [[CPython|CPython 运行时]] -- 对比: 字节码解释器 vs JIT
- [[JVM|JVM 运行时]] -- 对比: HotSpot C2 与 TurboFan
