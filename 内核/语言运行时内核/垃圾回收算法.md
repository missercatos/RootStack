...
- [[../../c语言教程/2深化/03_动态内存管理|C 动态内存管理]] -- malloc/free 的底层对比
- [[../../cpp教程/cpp深化教程/04_动态内存|C++ 动态内存]] -- RAII vs GC
- [[../../数据结构/A_容器_Container|容器]] -- GC 遍历的数据结构基础
- [[../../算法/算法技巧/连通性|连通性]] -- 可达性分析等价于图连通性
- [[CPython|CPython 运行时]] -- 引用计数 + 循环检测
- [[V8|V8 引擎]] -- Orinoco: 分代 + 并发 + 并行 GC
- [[JVM|JVM 运行时]] -- G1GC / ZGC
