...
### Step 1: [[数据结构/D_容器_Container|A 容器 Container]] (2 天)
...
### Step 2: [[数据结构/E_链表_LinkedList|D 链表 LinkedList]] (2 天)
...
### Step 3: [[数据结构/F_栈_Stack|B 栈 Stack]] (2 天)
...
### Step 4: [[数据结构/G_队列_Queue|F 队列 Queue]] (2 天)
...
### Step 5: [[数据结构/H_排序_八大排序_Sorting|Q 八大排序 Sorting]] (3 天)
...
### Step 7: [[数据结构/N_哈希表_HashTable|G 哈希表 HashTable]] (2 天)
...
### Step 8: [[数据结构/J_树_Tree_BST_AVL|I 树 / BST / AVL]] (3 天)
...
### Step 9: [[数据结构/I_堆_Heap|C 堆 Heap]] (2 天)
...
**回顾**: [[数据结构/H_排序_八大排序_Sorting|堆排序部分]]
...
### Step 10: [[数据结构/L_字典树_Trie|J 字典树 Trie]] (1 天)
...
**前置**: [[数据结构/I_堆_Heap|堆]] / [[数据结构/H_排序_八大排序_Sorting|排序]]
...
**前置**: [[数据结构/G_队列_Queue|队列]] / [[算法/算法技巧/前缀和|前缀和]]
...
**前置**: [[数据结构/F_栈_Stack|栈]] (递归=系统栈) / [[数据结构/H_排序_八大排序_Sorting|排序]]
...
**前置**: [[数据结构/F_栈_Stack|栈]] / [[数据结构/G_队列_Queue|队列]] / [[数据结构/J_树_Tree_BST_AVL|树]]
...
**前置**: [[算法/算法技巧/递推递归|递推递归]] / [[数据结构/D_容器_Container|容器]]
...
### Step 18: [[数据结构/S_图_Graph|H 图 Graph]] (3 天)
...
### Step 19: [[数据结构/O_并查集_UnionFind|K 并查集 UnionFind]] (2 天)
...
### Step 20: [[数据结构/T_图的高级算法_AdvancedGraph|P 图高级算法]] (3 天)
...
### Step 21: [[数据结构/Q_线段树_SegmentTree|L 线段树 SegmentTree]]
...
### Step 22: [[数据结构/R_树状数组_BIT|M 树状数组 BIT]]
...
### Step 23: [[数据结构/K_红黑树_RedBlackTree|E 红黑树 RedBlackTree]]
...
### Step 24: [[数据结构/M_B树_BTree|O B树 B-Tree]]
...
### Step 25: [[数据结构/P_跳表_SkipList|N 跳表 SkipList]]
...
**前置**: [[数据结构/L_字典树_Trie|Trie (RootStack)]]
...
**前置**: [[数据结构/G_队列_Queue|队列]] / [[算法/算法技巧/滑动窗口|滑动窗口]]
...
**前置**: [[数据结构/Q_线段树_SegmentTree|线段树]] / [[数据结构/N_哈希表_HashTable|哈希表]]
...
**重点**: 三维偏序、分治降维、归并排序思想
**前置**: [[算法/算法技巧/排序|排序]] / [[数据结构/R_树状数组_BIT|树状数组]]
...
**前置**: [[数据结构/J_树_Tree_BST_AVL|树/BST]]
