...
> 📌 **C语言内核编程**：Linux内核是世界上最大的C语言项目。要理解Rust在内核中的意义，必须先理解C语言在内核中的实践方式。请参阅 [[../../C语言深化教程/4内核/01_C语言与操作系统|C语言教程: C语言与操作系统]] 以及 [[../../C语言深化教程/4内核/07_Linux内核源码导读|C语言教程: Linux内核源码导读]]。
