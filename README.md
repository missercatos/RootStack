...
<p align="center">
  <a href="./git.md">Git 指南</a> · <a href="./github-settings.md">GitHub 设置</a> · <a href="./科学上网.md">科学上网</a> · <a href="./linux/">Linux 教程</a> · <a href="./国际付费操作.md">国际付费</a> · <a href="./red_team/总目录与快速查询.md">红队知识库</a> · <a href="./计算机网络/计算机网络_索引.md">计算机网络</a> · <a href="./408统考索引.md">408统考索引</a> · <a href="./ISSUES.md">参与贡献</a>
</p>
...
**路径说明**: 路径 A-F 和三条新路径覆盖计算机科学通识与工程化方向；路径 E 是**职业分化路径**——网络安全（红队），基于 ArchStrike 体系，已覆盖 ~148 篇知识库文件。**新增**: 408统考索引提供四科考点全覆盖的交叉映射，三条新路径（考研408/工程化底层/工程化应用）补全学习路线。
...
| 路径 | 文件 | 适合人群 |
|------|------|---------|
| A: C 主线 | [[路径A-C主线]] | 系统编程/嵌入式/内核开发 |
| B: C++ 主线 | [[路径B-CPP主线]] | 应用开发 + 底层贯通 |
| C: C→C++ | [[路径C-C向下兼容C++]] | 先 C 后 C++ 向下兼容 |
| D: DSA 刷题 | [[路径D-DSA算法刷题]] | 数据结构与算法/力扣练习/竞赛入门 |
| F: Rust 学习 | [[路径F-Rust学习路径]] | C++ 之后的系统编程进阶 |
| 考研408路径 | [[路径-考研408方向]] | 408计算机统考四科系统备考 |
| 工程化底层 | [[路径-工程化底层方向]] | C/汇编/OS/内核/驱动与性能工程 |
| 工程化应用 | [[路径-工程化应用方向]] | C++/前后端/数据库/网络应用开发 |
...
| 路径 | 文件 | 适合人群 |
|------|------|---------|
| E: 红队 (ArchStrike) | [[路径E-红队职业路径]] | 网络安全/渗透测试/CTF/红队攻防 |
| Rust 特殊方向 | [[路径F-Rust学习路径]] | Rust 系统编程与工具开发 |
...
| 计算机原理 | [[计算机原理/计算机原理_索引\|计算机原理教程]] | 大学本科课标 + 深入底层 (10篇) |
| 计算机网络 | [[计算机网络/计算机网络_索引\|计算机网络教程]] | 大学本科课标 + 深入底层 (7篇, 408全覆盖) |
| 408统考索引 | [[408统考索引]] | 四科考点全覆盖的交叉映射表 |
