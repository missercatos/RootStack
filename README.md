...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/版本-0.3.0-blue?style=flat-square" alt="version"/>
</p>
...
├── 路径D-DSA算法刷题.md         竞赛策略完全路线图 (12 Phase, 53 Step)
├── 路径E-红队职业路径.md        网络安全职业路径 (ArchStrike体系)
├── 路径F-Rust学习路径.md        Rust 学习路径 (C++ 之后的系统编程进阶)
...
| D: DSA 刷题 | [[ISSUES|路径D-DSA算法刷题]] | 算法竞赛/面试/洛谷刷题 |
...
| 路径 | 文件 | 适合人群 |
|------|------|---------|
| E: 红队 (ArchStrike) | [[ISSUES|路径E-红队职业路径]] | 网络安全/渗透测试/CTF/红队攻防 |
...
| 数据结构 | [[ISSUES|DSA 学习路线]] | 18个主题, Phase 1→5, 洛谷题目 |
...
| 7.18 | 签到题重写   | red_team/ctf_trea/签到题.md 重写为 406 行全面指南: 10 大类陷阱 + Windows/Linux/macOS 三系统解法 |
| 7.18 | 链接修复     | 全项目 730 个失效双链接修复为 0, 自动化批量路径校正 + 手动精准修复 |
| 7.18 | OI-wiki移植  | 从 OI-wiki 移植 32 篇算法文件: 图论(15篇) + 字符串扩展(8篇) + DP进阶(9篇), 新建 算法/图论/ 算法/字符串扩展/ 算法/DP进阶/ |
| 7.18 | 题目存档     | 新建 算法/题目/ 目录, 存放 CTF/算法题目对应文件, 解决链接失效问题 |
