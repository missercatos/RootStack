...
> 同时推荐与 AI 进行问答互动学习——在自认为掌握语法或数据结构之后，去洛谷或力扣做题验证。
> 如遇到错误，不建议死磕，可用 AI 辅助纠正思路。

> 前置条件：已有 C++/C 的扎实基础（理解指针、堆栈、RAII、OOP），或已完成 [[路径-CPP开发]] 的至少 Phase 1-3。
...
| 算法 | 所有算法题均可用 Rust 实现 | [[算法/算法技巧/动态规划|DP 技巧]] |
...
| 多语言工程化 | Rust 与其他语言的 FFI、服务协作与交付 | [[多语言工程化/多语言工程化目录|多语言工程化]] |
