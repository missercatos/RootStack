...
| 顺序 | 文件 | 重点 | 技巧 |
|------|------|------|------|
| 0 | [[1入门/00_准备工作\|00 准备工作]] | 各系统安装配置、编辑器选择 | 终端 REPL 即可跑 Python |
...
| 领域 | 入口目录 | 核心库 |
|------|---------|--------|
| 工程化 | [[5工程化/01_venv与uv：环境隔离\|5工程化/]] | venv/uv/conda/pytest/ruff/pyproject.toml |
| 从零运行项目 | [[5工程化/07_从零运行一个Python项目\|运行现有项目]] | 克隆/虚拟环境/pip install/运行 |
| Conda 环境管理 | [[5工程化/08_Conda：科学计算的环境与包管理\|Conda]] | conda create python=3.10/PyTorch |
