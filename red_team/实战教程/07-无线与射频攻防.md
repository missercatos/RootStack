...
>
> 环境：Linux（任意发行版），工具用包管理器或从 GitHub 获取。硬件清单见文末 Part 8。
>
...
```bash
# 安装 pixiewps：用包管理器或从 GitHub 获取（AUR）
...
# 安装RTL-SDR工具链
# 用包管理器安装 rtl-sdr、gnuradio、gqrx、urh，或从各自 GitHub 获取
...
```bash
# 安装 rtl_433：用包管理器或从 GitHub 获取（基础扫描（自动识别和解码））
