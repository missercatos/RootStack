...
> 
> **环境**：Linux 物理机（任意发行版）。已装 opencode-ai-bin、Claude Code（可选）、Cursor IDE（可选）、Ollama（可选）。
> 
...
**opencode 会根据你系统的实际环境调整代码**——比如它会根据系统环境选择解释器路径（`#!/usr/bin/env python3`），并考虑 Python 版本兼容性。
