...
所需环境: Linux 攻击机 (攻击机), Linux靶机 (如Metasploitable2/3)
...
基础命令与系统操作参考 [[../渗透基础/01-基础命令与Linux安全操作|基础命令与Linux安全操作]]。
...
```bash
# 安装 unix-privesc-check：用包管理器或从 GitHub 获取
```
...
环境: 攻击机(Linux) + 目标机(Metasploitable2, IP: 192.168.56.102)
