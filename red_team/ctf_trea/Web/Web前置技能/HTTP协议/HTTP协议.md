...
- [[请求方式|请求方式修改解题]] -- 自定义 HTTP 方法获取 flag 的具体题目解法
- [[302跳转|302 跳转解题]] -- 重定向响应中隐藏 flag 的题目解法
- [[Cookie|Cookie 篡改解题]] -- 修改 Cookie 值获取 flag 的题目解法
- [[基本认证|基本认证解题]] -- HTTP Basic 认证绕过与爆破的题目解法
- [[源代码|源代码解题]] -- 响应包源码中查找 flag 的题目解法
