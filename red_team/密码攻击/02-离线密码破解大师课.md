...
涉及工具：hashcat, john (John the Ripper)
...
```bash
# 安装 hashcat：用包管理器或从 GitHub 获取（或）
# 安装 hashcat-utils：用包管理器或从 GitHub 获取
```
...
```bash
# 安装
# 安装 john：用包管理器或从 GitHub 获取（自动检测哈希类型并破解）
