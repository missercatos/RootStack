...
- [[#一、Metasploit 框架完整教程|一、Metasploit 框架完整教程]]
 - [[#1.1 Metasploit 架构概述|1.1 Metasploit 架构概述]]
 - [[#1.2 MSFConsole 启动与界面|1.2 MSFConsole 启动与界面]]
 - [[#1.3 核心操作命令|1.3 核心操作命令]]
 - [[#1.4 Payload 管理|1.4 Payload 管理]]
 - [[#1.5 执行利用与会话管理|1.5 执行利用与会话管理]]
 - [[#1.6 Meterpreter 核心命令|1.6 Meterpreter 核心命令]]
- [[#二、searchsploit 使用|二、searchsploit 使用]]
 - [[#2.1 工具介绍|2.1 工具介绍]]
 - [[#2.2 基本搜索|2.2 基本搜索]]
 - [[#2.3 查看和复制 Exploit|2.3 查看和复制 Exploit]]
 - [[#2.4 常用搜索模式|2.4 常用搜索模式]]
- [[#三、Nikto Web 漏洞扫描|三、Nikto Web 漏洞扫描]]
 - [[#3.1 工具介绍|3.1 工具介绍]]
 - [[#3.2 基本扫描|3.2 基本扫描]]
 - [[#3.3 高级选项|3.3 高级选项]]
- [[#四、实践练习|四、实践练习]]
...
> 相关模块: [[01-基础命令与Linux安全操作|Linux 基础]] | [[02-信息收集与侦察技术|信息收集]] | [[03-网络扫描与枚举技术|网络扫描]]
...
searchsploit 是 Exploit-DB 的离线搜索工具, 包含大量已验证的 exploit代码。数据通常位于 `/usr/share/exploitdb/`
...
- 练习不同payload类型: `cmd/unix/reverse`, `java/meterpreter`, `linux/x86/meterpreter` 等
- 记录每个利用所需的确切命令, 这对报告和复现很重要
- 如果不确定某个模块的参数, 使用 `show info` 查看详细说明

---

[[../总目录与快速查询|总目录]] | [[03-网络扫描与枚举技术|上一章: 网络扫描]]
