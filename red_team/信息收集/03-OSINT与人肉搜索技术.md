...
> 相关模块: [[01-高级子域名与资产发现|子域名发现]] | [[02-高级DNS侦察技术|DNS 侦察]] | [[../渗透基础/02-信息收集与侦察技术|信息收集基础]]
...
```bash
# 安装 python-shodan：用包管理器或从 GitHub 获取
...
```bash
# 安装 trufflehog：用包管理器或从 GitHub 获取
