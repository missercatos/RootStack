...
> 相关模块: [[01-高级子域名与资产发现|子域名发现]] | [[03-OSINT与人肉搜索技术|OSINT 技术]] | [[../渗透基础/02-信息收集与侦察技术|信息收集基础]]
...
```bash
# 安装 bing-ip2hosts：用包管理器或从 GitHub 获取
