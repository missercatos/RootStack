...
> 相关模块: [[../渗透基础/02-信息收集与侦察技术|信息收集基础]] | [[02-高级DNS侦察技术|DNS 侦察]] | [[03-OSINT与人肉搜索技术|OSINT 技术]]
...
```bash
# 安装 subfinder：用包管理器或从 GitHub 获取
...
```bash
# 安装 assetfinder：用包管理器或从 GitHub 获取
