...
除了逻辑导出，还可以**直接拷贝数据目录**。数据目录位置按安装方式不同：
...
本章与 [[06-存储过程与触发器|06 存储过程与触发器]]、[[07-主从复制与高可用|07 主从复制与高可用]]、[[08-与后端语言集成|08 与后端语言集成]]、[[09-高级主题与性能诊断|09 高级主题与性能诊断]] 共同构成 MySQL 进阶线。继续横向扩展：[[../postgresql/PostgreSQL教程|PostgreSQL 教程]] 或 [[../sqlite/SQLite教程|SQLite 教程]]
