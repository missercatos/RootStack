...
- [[../../数据结构/E_容器_Container|E_容器_Container]] — vector 用于 DP 状态存储（一维/二维 DP 表）
- [[../../数据结构/J_堆_Heap|J_堆_Heap]] — 优先队列可优化部分 DP（如 Dijkstra 本质 = DP + 贪心）
- [[../../数据结构/H_队列_Queue|H_队列_Queue]] — 单调队列优化部分 DP（如单调队列优化多重背包）
...
- **[[../../数据结构/E_容器_Container|E_容器_Container]]**: vector 是 DP 表格的存储容器
- **[[../../数据结构/J_堆_Heap|J_堆_Heap]]**: 优先队列可优化部分 DP (如 Dijkstra 本质是 DP + 贪心)
