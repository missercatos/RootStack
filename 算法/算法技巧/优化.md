...
- [[../../数据结构/G_队列_Queue|G_队列_Queue]] — deque 实现 0-1 BFS
- [[../../数据结构/I_堆_Heap|I_堆_Heap]] — priority_queue 用于常规 Dijkstra
- [[../../数据结构/O_并查集_UnionFind|O_并查集_UnionFind]] — Kruskal 路径压缩
