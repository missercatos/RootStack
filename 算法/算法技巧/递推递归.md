---
title: "C++ 算法技巧 — 递推与递归 (Iteration & Recursion)"
---
...
- [[../../数据结构/F_栈_Stack|F_栈_Stack]] — 递归本质使用系统调用栈
- [[../../数据结构/J_树_Tree_BST_AVL|J_树_Tree_BST_AVL]] — 树的递归遍历、分治建树
- [[../../数据结构/H_排序_八大排序_Sorting|H_排序_八大排序_Sorting]] — 归并/快排的分治递归思想
