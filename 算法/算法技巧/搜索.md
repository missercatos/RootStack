...
- [[../../数据结构/B_栈_Stack|B_栈_Stack]] — DFS 用栈 (递归调用栈)
- [[../../数据结构/F_队列_Queue|F_队列_Queue]] — BFS 用队列逐层扩展
- [[../../数据结构/I_树_Tree_BST_AVL|I_树_Tree_BST_AVL]] — 树的 DFS/BFS 遍历
- [[../../数据结构/H_图_Graph|H_图_Graph]] — 图上的搜索遍历
