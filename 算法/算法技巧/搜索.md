...
- [[../../数据结构/G_栈_Stack|G_栈_Stack]] — DFS 用栈 (递归调用栈)
- [[../../数据结构/H_队列_Queue|H_队列_Queue]] — BFS 用队列逐层扩展
- [[../../数据结构/K_树_Tree_BST_AVL|K_树_Tree_BST_AVL]] — 树的 DFS/BFS 遍历
- [[../../数据结构/T_图_Graph|T_图_Graph]] — 图上的搜索遍历
