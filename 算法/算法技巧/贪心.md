...
- [[../数据结构/C_堆_Heap]] — priority_queue 实现合并果子、哈夫曼编码 (O(log n) 取最小)
- [[../数据结构/A_容器_Container]] — vector 排序后贪心遍历
- [[../数据结构/Q_排序_八大排序_Sorting]] — 排序是大多数贪心问题的预处理步骤
...
- **[[搜索]]**: 贪心是搜索的剪枝/近似的替代方案
- **[[前缀和]]**: 区间贪心问题配合前缀和优化
- **[[../数据结构/C_堆_Heap]]**: priority_queue 实现合并果子、哈夫曼编码
- **[[../数据结构/A_容器_Container]]**: vector 排序后贪心遍历
