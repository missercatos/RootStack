...
本节侧重底层实现与内存理解，与 [[../cpp深化教程/数据结构/F_队列_Queue|CPP教程对应章节]] 形成互补——CPP教程侧重 `std::queue`/`std::deque` 的STL使用与适配器模式，本教程侧重用C手动实现多种队列结构，特别是内核编程中至关重要的**环形缓冲区**（Circular Buffer / Ring Buffer）。
...
> 无锁（lock-free）环形缓冲区的原理涉及内存序和 CAS 操作，参见 [[../ASM教程/07_原子操作|ASM: 原子操作]]。
...
> BFS 与图算法的更多内容，参见 [[08_图|图]] 章节和 [[../cpp深化教程/数据结构/H_图_Graph|CPP: 图]]。
...
| 题号 | 题目 | 难度 | 知识点 |
|------|------|------|--------|
| [P1540](https://www.luogu.com.cn/problem/P1540) | 机器翻译 | 普及- | 队列模拟 |
| [P1996](https://www.luogu.com.cn/problem/P1996) | 约瑟夫问题 | 入门 | 队列模拟 |
| [P1886](https://www.luogu.com.cn/problem/P1886) | 滑动窗口 | 普及 | 单调队列 |
| [P1440](https://www.luogu.com.cn/problem/P1440) | 求m区间内的最小值 | 普及 | 单调队列 |
| [P1714](https://www.luogu.com.cn/problem/P1714) | 切蛋糕 | 普及 | 单调队列+前缀和 |
...
- **上一章**: [[03_栈|栈]] | **下一章**: [[05_哈希表|哈希表]] | **返回**: [[../目录|目录]]
- **CPP对照**: [[../cpp深化教程/数据结构/F_队列_Queue|CPP: 队列]] | [[../cpp深化教程/容器库/05_queue|CPP: queue]]
- **相关**: [[2深化/01_指针深度剖析|指针深度剖析]] | [[2深化/03_动态内存管理|动态内存管理]]
- **ASM**: [[../ASM教程/03_栈与函数|ASM: 栈与函数]] | [[../ASM教程/07_原子操作|ASM: 原子操作]]
