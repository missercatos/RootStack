...
本节侧重底层实现与内存理解，与 [[../cpp深化教程/数据结构/H_图_Graph|CPP教程对应章节]] 形成互补——CPP教程侧重图的 STL 表示（`vector<vector<int>>`）、算法模板与竞赛优化，本教程侧重手动实现邻接矩阵和邻接表、BFS/DFS 的底层细节、以及大型图的内存管理策略。
...
> 关于栈溢出的硬件原理，参见 [[../ASM教程/03_栈与函数|ASM: 栈与函数]]。
...
| 题号 | 题目 | 难度 | 知识点 |
|------|------|------|--------|
| [P5318](https://www.luogu.com.cn/problem/P5318) | 查找文献 | 普及- | BFS/DFS 基础 |
| [P3916](https://www.luogu.com.cn/problem/P3916) | 图的遍历 | 普及 | 反向图 + DFS |
| [P1113](https://www.luogu.com.cn/problem/P1113) | 杂务 | 普及- | 拓扑排序 |
| [P4779](https://www.luogu.com.cn/problem/P4779) | 单源最短路径 | 普及+ | Dijkstra 堆优化 |
| [P3385](https://www.luogu.com.cn/problem/P3385) | 负环 | 提高 | SPFA/Bellman-Ford |
| [P4017](https://www.luogu.com.cn/problem/P4017) | 最大食物链计数 | 普及 | 拓扑排序 + DP |
...
- **上一章**: [[07_堆|堆]] | **下一章**: [[09_高级数据结构|高级数据结构]] | **返回**: [[../目录|目录]]
- **CPP对照**: [[../cpp深化教程/数据结构/H_图_Graph|CPP: 图]] | [[../cpp深化教程/数据结构/P_图的高级算法_AdvancedGraph|CPP: 图的高级算法]]
- **相关**: [[04_队列|队列（BFS用）]] | [[07_堆|堆（Dijkstra优先队列用）]] | [[03_栈|栈（DFS用）]]
- **ASM**: [[../ASM教程/03_栈与函数|ASM: 栈与函数（DFS栈深度）]]
