...
本节侧重底层实现与内存理解，与 [[../cpp深化教程/数据结构/I_树_Tree_BST_AVL|CPP教程对应章节]] 形成互补——CPP教程侧重 `std::set`/`std::map`（基于红黑树）的STL使用、迭代器语义和算法，本教程侧重手动实现二叉搜索树和AVL树的插入/删除/旋转，深刻理解树节点间的指针关系。
...
> 关于系统栈与自定义栈的对比——递归 vs 迭代，参见 [[../ASM教程/03_栈与函数|ASM: 栈与函数]]。
...
| 题号 | 题目 | 难度 | 知识点 |
|------|------|------|--------|
| [P4913](https://www.luogu.com.cn/problem/P4913) | 二叉树深度 | 入门 | 二叉树、递归 |
| [P1305](https://www.luogu.com.cn/problem/P1305) | 新二叉树 | 普及- | 二叉树遍历 |
| [P1030](https://www.luogu.com.cn/problem/P1030) | 求先序排列 | 普及- | 中序+后序求先序 |
| [P1827](https://www.luogu.com.cn/problem/P1827) | 美国血统 | 普及- | 前序+中序求后序 |
| [P3369](https://www.luogu.com.cn/problem/P3369) | 普通平衡树 | 提高 | BST、平衡树 |
| [P1801](https://www.luogu.com.cn/problem/P1801) | 黑匣子 | 提高 | 对顶堆+BST |
...
- **上一章**: [[05_哈希表|哈希表]] | **下一章**: [[07_堆|堆]] | **返回**: [[../目录|目录]]
- **CPP对照**: [[../cpp深化教程/数据结构/I_树_Tree_BST_AVL|CPP: 树/BST/AVL]] | [[../cpp深化教程/数据结构/E_红黑树_RedBlackTree|CPP: 红黑树]]
- **相关**: [[2深化/01_指针深度剖析|指针深度剖析（指针关系）]] | [[2深化/03_动态内存管理|动态内存管理（树节点分配）]]
- **ASM**: [[../ASM教程/03_栈与函数|ASM: 栈与函数（递归的栈帧）]]
