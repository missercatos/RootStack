...
本节侧重底层实现与内存理解，与 [[../cpp深化教程/数据结构/C_堆_Heap|CPP教程对应章节]] 形成互补——CPP教程侧重 `std::priority_queue` 的 STL 使用、自定义比较器与算法，本教程侧重手动实现二叉堆的数组存储、sift-up/sift-down 操作、以及堆在优先队列和排序中的应用。
...
> 关于数组索引到地址的汇编转换 `[base + index * size]`，参见 [[../ASM教程/02_寄存器与寻址|ASM: 寄存器与寻址]]。
...
| 题号 | 题目 | 难度 | 知识点 |
|------|------|------|--------|
| [P3378](https://www.luogu.com.cn/problem/P3378) | 堆模板 | 普及- | 最小堆 |
| [P1090](https://www.luogu.com.cn/problem/P1090) | 合并果子 | 普及- | 贪心+堆 |
| [P1168](https://www.luogu.com.cn/problem/P1168) | 中位数 | 普及 | 对顶堆 |
| [P1801](https://www.luogu.com.cn/problem/P1801) | 黑匣子 | 提高 | 对顶堆 |
| [P2085](https://www.luogu.com.cn/problem/P2085) | 最小函数值 | 普及- | 堆、多路归并 |
...
- **上一章**: [[06_树与二叉树|树与二叉树]] | **下一章**: [[08_图|图]] | **返回**: [[../目录|目录]]
- **CPP对照**: [[../cpp深化教程/数据结构/C_堆_Heap|CPP: 堆]] | [[../cpp深化教程/容器库/07_priority_queue|CPP: priority_queue]]
- **相关**: [[2深化/01_指针深度剖析|指针深度剖析]] | [[2深化/03_动态内存管理|动态内存管理]]
- **ASM**: [[../ASM教程/02_寄存器与寻址|ASM: 寄存器与寻址]]
