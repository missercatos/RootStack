...
本节侧重底层实现与内存理解，与 CPP 教程的 [[../../数据结构/O_字典树_Trie|Trie]]、[[../../数据结构/Q_并查集_UnionFind|Union-Find]]、[[../../数据结构/S_线段树_SegmentTree|线段树]]、[[../../数据结构/R_跳表_SkipList|跳表]]、[[../../数据结构/N_B树_BTree|B树]] 等对应章节形成互补——CPP教程侧重使用模式和算法优化，本教程深入内存布局和手动实现。
...
> 关于 Trie 的 C++ STL 无法直接使用（没有标准 Trie 容器），CPP 教程中展示了竞赛场景下的实现，参见 [[../../数据结构/O_字典树_Trie|CPP: Trie]]。
...
> 关于并查集在 Kruskal 最小生成树算法中的应用，参见 [[../../数据结构/Q_并查集_UnionFind|CPP: 并查集]]。
...
> 关于跳表的 C++ 实现（无标准库支持），参见 [[../../数据结构/R_跳表_SkipList|CPP: 跳表]]。
...
> 关于线段树在竞赛中的更多变体（动态开点、可持久化线段树、树状数组对比），参见 [[../../数据结构/S_线段树_SegmentTree|CPP: 线段树]] 和 [[../../数据结构/T_树状数组_BIT|CPP: 树状数组]]。
...
- **上一章**: [[08_图|图]] | **返回**: 
- **CPP对照**: [[../../数据结构/O_字典树_Trie|CPP: Trie]] | [[../../数据结构/Q_并查集_UnionFind|CPP: 并查集]] | [[../../数据结构/S_线段树_SegmentTree|CPP: 线段树]] | [[../../数据结构/R_跳表_SkipList|CPP: 跳表]] | [[../../数据结构/N_B树_BTree|CPP: B树]]
