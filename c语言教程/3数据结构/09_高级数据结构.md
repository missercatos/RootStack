...
本节侧重底层实现与内存理解，与 CPP 教程的 [[../cpp深化教程/数据结构/J_字典树_Trie|Trie]]、[[../cpp深化教程/数据结构/K_并查集_UnionFind|Union-Find]]、[[../cpp深化教程/数据结构/L_线段树_SegmentTree|线段树]]、[[../cpp深化教程/数据结构/N_跳表_SkipList|跳表]]、[[../cpp深化教程/数据结构/O_B树_BTree|B树]] 等对应章节形成互补——CPP教程侧重使用模式和算法优化，本教程深入内存布局和手动实现。
...
> 关于 Trie 的 C++ STL 无法直接使用（没有标准 Trie 容器），CPP 教程中展示了竞赛场景下的实现，参见 [[../cpp深化教程/数据结构/J_字典树_Trie|CPP: Trie]]。
...
> 关于并查集在 Kruskal 最小生成树算法中的应用，参见 [[../cpp深化教程/数据结构/K_并查集_UnionFind|CPP: 并查集]]。
...
> 关于跳表的 C++ 实现（无标准库支持），参见 [[../cpp深化教程/数据结构/N_跳表_SkipList|CPP: 跳表]]。
...
> 在 C++ 中 B树通常通过数据库引擎（如 SQLite）实现，无标准 STL 容器。参见 [[../cpp深化教程/数据结构/O_B树_BTree|CPP: B树]]。
...
> 关于线段树在竞赛中的更多变体（动态开点、可持久化线段树、树状数组对比），参见 [[../cpp深化教程/数据结构/L_线段树_SegmentTree|CPP: 线段树]] 和 [[../cpp深化教程/数据结构/M_树状数组_BIT|CPP: 树状数组]]。
...
| 题号 | 题目 | 难度 | 知识点 |
|------|------|------|--------|
| [P2580](https://www.luogu.com.cn/problem/P2580) | 于是他错误的点名开始了 | 普及- | Trie |
| [P3367](https://www.luogu.com.cn/problem/P3367) | 并查集模板 | 普及- | 并查集 |
| [P1551](https://www.luogu.com.cn/problem/P1551) | 亲戚 | 普及- | 并查集 |
| [P3372](https://www.luogu.com.cn/problem/P3372) | 线段树1（区间加） | 普及+ | 线段树+懒标记 |
| [P3373](https://www.luogu.com.cn/problem/P3373) | 线段树2（区间加+乘） | 提高 | 线段树+复合懒标记 |
| [P3870](https://www.luogu.com.cn/problem/P3870) | 开关 | 普及- | 线段树/分块 |
...
- **上一章**: [[08_图|图]] | **返回**: [[../目录|目录]]
- **CPP对照**: [[../cpp深化教程/数据结构/J_字典树_Trie|CPP: Trie]] | [[../cpp深化教程/数据结构/K_并查集_UnionFind|CPP: 并查集]] | [[../cpp深化教程/数据结构/L_线段树_SegmentTree|CPP: 线段树]] | [[../cpp深化教程/数据结构/N_跳表_SkipList|CPP: 跳表]] | [[../cpp深化教程/数据结构/O_B树_BTree|CPP: B树]]
- **相关**: [[06_树与二叉树|树与二叉树（线段树的树形基础）]] | [[05_哈希表|哈希表（Trie vs 哈希表对比）]] | [[08_图|图（并查集在图中的应用）]]
- **ASM**: [[../ASM教程/06_缓存与内存序|ASM: 缓存与内存序（B树节点设计）]]
