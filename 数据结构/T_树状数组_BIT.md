...
建议先阅读: [[S_线段树_SegmentTree|R 线段树 SegmentTree]]
...
| BIT[i] | lowbit | 管辖范围 | 计算过程 | 值 |
|:------:|:------:|:--------:|:--------:|:--:|
| BIT[1] | 1 | [1,1] | arr[1] | 1 |
| BIT[2] | 2 | [1,2] | arr[1]+arr[2] = 1+3 | 4 |
| BIT[3] | 1 | [3,3] | arr[3] | 5 |
| BIT[4] | 4 | [1,4] | arr[1]+arr[2]+arr[3]+arr[4] = 1+3+5+7 | 16 |
| BIT[5] | 1 | [5,5] | arr[5] | 9 |
| BIT[6] | 2 | [5,6] | arr[5]+arr[6] = 9+11 | 20 |
| BIT[7] | 1 | [7,7] | arr[7] | 13 |
| BIT[8] | 8 | [1,8] | arr[1]+...+arr[8] | 64 |
