...
```
Level 3:  HEAD ─────────────────────────────── 25 ──────── NIL
Level 2:  HEAD ────── 6 ────────────────────── 25 ── 30 ── NIL
Level 1:  HEAD ── 3 ── 6 ────── 12 ────────── 25 ── 30 ── NIL
Level 0:  HEAD ── 3 ── 6 ── 8 ── 12 ── 17 ── 25 ── 30 ── NIL
```

查找17的过程：
1. Level 3: HEAD → 25 (25>17, 下降)
2. Level 2: HEAD → 6 → 25 (25>17, 下降到6)
3. Level 1: 6 → 12 → 25 (25>17, 下降到12)
4. Level 0: 12 → 17 (找到!)
