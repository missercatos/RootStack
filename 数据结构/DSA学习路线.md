...
内存、CPU、缓存、指针、数学基础，以及**语句频度的数法与时间/空间复杂度的数学计算**（求和公式、递推方程、主定理、平均情况期望）。所有数据结构的硬件和数学根基，必须最先阅读。
...
线性表是最基础的抽象数据类型：n 个元素的有限序列，两种存储实现（顺序表/链表）的总览与取舍。重点掌握顺序表的插入/删除算法与**平均移动次数推导**（插入 n/2、删除 (n-1)/2），以及 408 高频的顺序表算法设计题（合并、就地逆置、删除、中位数、循环移位）。
...
前置知识: [[J_堆_Heap]]、[[I_排序_八大排序_Sorting]]
...
前置知识: [[G_栈_Stack]]、[[I_排序_八大排序_Sorting]]
...
前置知识: [[G_栈_Stack]]、[[H_队列_Queue]]、[[K_树_Tree_BST_AVL]]
...
前置知识: [[../算法/算法技巧/递推递归]]、[[E_容器_Container]]
...
| 顺序 | 文件 | 建议时机 |
|------|------|----------|
| 21 | [[R_线段树_SegmentTree]] | 学完数组、递归后可选 |
| 22 | [[S_树状数组_BIT]] | 学完线段树后再看 |
| 23 | [[Q_跳表_SkipList]] | 学完链表、哈希后可选 |
| 24 | [[L_红黑树_RedBlackTree]] | 学完 BST/AVL 后可选 |
| 25 | [[N_B树_BTree]] | 学完树、文件系统概念后可选 |
...
|-------------|----------|---------------|
| [[../算法/算法技巧/数组]] | 无 | [[E_容器_Container]] |
| [[../算法/算法技巧/循环]] | 无 | [[E_容器_Container]] |
| [[../算法/算法技巧/暴力枚举]] | 循环 + 数组 | [[I_排序_八大排序_Sorting]] |
| [[../算法/算法技巧/二分查找]] | 排序 | [[I_排序_八大排序_Sorting]] |
| [[../算法/算法技巧/双指针]] | 数组 + 循环 | [[F_链表_LinkedList]] |
| [[../算法/算法技巧/前缀和]] | 数组 + 循环 | [[E_容器_Container]] |
| [[../算法/算法技巧/差分]] | 前缀和 | [[E_容器_Container]] |
| [[../算法/算法技巧/二分答案]] | 二分查找 | [[I_排序_八大排序_Sorting]] |
| [[../算法/算法技巧/贪心]] | 排序 | [[J_堆_Heap]] |
| [[../算法/算法技巧/滑动窗口]] | 双指针 + 前缀和 | [[H_队列_Queue]] |
| [[../算法/算法技巧/递推递归]] | 函数 + 数组 | [[G_栈_Stack]] |
| [[../算法/算法技巧/搜索]] | 递推递归 | [[G_栈_Stack]], [[H_队列_Queue]], [[K_树_Tree_BST_AVL]] |
| [[../算法/算法技巧/动态规划]] | 递推递归 + 堆 | [[E_容器_Container]] |
| [[../算法/算法技巧/图]] | 搜索 + 贪心 | [[T_图_Graph]] |
| [[../算法/算法技巧/连通性]] | 图 + 搜索 | [[P_并查集_UnionFind]] |
| [[../算法/算法技巧/优化]] | 全部 | [[R_线段树_SegmentTree]], [[S_树状数组_BIT]] |
