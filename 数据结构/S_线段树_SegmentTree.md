...
建议先阅读: [[G_容器_Container|E 容器 Container]], [[../算法/算法技巧/递推递归|递推递归]]
...
```mermaid
graph TD
    T1["tree[1]=[0,5]=36"] --> T2["tree[2]=[0,3]=16"]
    T1 --> T3["tree[3]=[4,5]=20"]
    T2 --> T4["tree[4]=[0,1]=4"]
    T2 --> T5["tree[5]=[2,3]=12"]
    T3 --> T6["tree[6]=[4,5]=20"]
    T4 --> T8["tree[8]=[0,0]=1"]
    T4 --> T9["tree[9]=[1,1]=3"]
    T5 --> T10["tree[10]=[2,2]=5"]
    T5 --> T11["tree[11]=[3,3]=7"]
    T6 --> T12["tree[12]=[4,4]=9"]
    T6 --> T13["tree[13]=[5,5]=11"]
```
