...
> 系统性深入学习汇编与硬件操作，请参阅：[[../汇编目录|汇编基础教程]]
...
| 题号 | 题目 | 链接 | 涉及知识点 |
|------|------|------|-----------|
| 136 | 只出现一次的数字 | https://leetcode.cn/problems/single-number/ | 异或运算（xor指令） |
| 137 | 只出现一次的数字 II | https://leetcode.cn/problems/single-number-ii/ | 位操作、状态机 |
| 191 | 位1的个数 | https://leetcode.cn/problems/number-of-1-bits/ | popcnt指令、位运算 |
| 231 | 2的幂 | https://leetcode.cn/problems/power-of-two/ | test指令、位特性 |
