...
⚠️ 注意：使用委托构造时，初始化列表中不能有其他成员初始化器。
...
✏️ 习题：设计一个"智能手环数据记录器"类 SmartBand
## ================================================
