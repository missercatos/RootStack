...
<p align="center">
 <em>以 C 作为出发点，覆盖多领域、多计算机语言的百科全书式教程 —— C、C++、Python、Rust、Dart、数据结构与算法、Linux 系统、系统内核、汇编、网络安全（红队）</em>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/版本-0.33.0-blue?style=flat-square" alt="version"/>
</p>
...
**路径说明**: 8 条学习路径覆盖 C、C++、Java、Rust、Python、Dart 六大语言方向，以及考研和渗透测试两个专业方向。每条路径从入门到进阶，按阶段推进。另有 `多语言工程化/` 模块专门讲解多人多语言项目的统筹协作、跨语言构建测试与容器编排。
...
├── 路径-CPP开发.md C++ 开发: 从零到应用开发
├── 路径-Java开发.md Java 开发: 全栈工程师路径
├── 路径-Rust开发.md Rust 开发: 系统编程进阶
├── 路径-Python开发.md Python 开发: 数据科学与AI
...
│
├── dart/ (34篇) Dart/Flutter 教程: 入门 → 深入 → 框架 → 工程化
│ ├── dart目录.md
│ ├── 1入门/ (12篇) 语法 + 集合 + OOP + 空安全 + 异步 + 包管理
│ ├── 2深入/ (6篇) 泛型 + Isolate + FFI + 元编程 + 测试 + 编译产物
│ ├── 3框架/ (12篇) Flutter全流程 + 服务端Dart + Flame游戏 + Web/桌面
│ └── 4工程化/ (3篇) 架构规范 + CI自动发布 + 包发布
│
├── 多语言工程化/ (30篇) 多人多语言项目统筹: 协作 → 构建 → 协议 → 测试 → 容器 → 交付
│ ├── 多语言工程化目录.md
│ ├── 1统筹与协作/ (6篇) Monorepo + 接口先行 + 团队分工 + Git工作流 + 版本策略
│ ├── 2构建与依赖/ (4篇) 构建系统全景 + Bazel + 私有仓库 + 交叉编译
│ ├── 3接口与协议/ (6篇) FFI + Protobuf/gRPC + REST/OpenAPI + 消息队列 + 序列化
│ ├── 4测试与质量/ (4篇) 测试策略 + 契约测试 + E2E编排 + 质量门禁
│ ├── 5容器与编排/ (6篇) 统一容器化 + Compose + K8s核心/实战 + Helm/GitOps + 可观测性
│ └── 6持续交付/ (3篇) 流水线设计 + GitHub Actions + 发布回滚
│
...
│
├── 数据结构/ (23篇)             语言无关的数据结构教程 + DSA学习路线
│ ├── A_数组_Array → V_图的高级算法 (共22篇，A-V连续编号，线性结构在前)
│ ├── C_顺序表_SequentialList.md 顺序表（线性表 ADT + 平均移动次数 + 408 算法题）
│
...
以下路径按开发方向划分，覆盖 C、C++、Java、Rust、Python、Dart 六大语言方向，以及考研和渗透测试两个专业方向。

| 路径 | 文件 | 适合人群 |
|------|------|---------|
| C 开发 | [路径-C开发](路径-C开发.md) | 系统编程/嵌入式/内核开发 |
| C++ 开发 | [路径-CPP开发](路径-CPP开发.md) | 应用开发/后端服务/游戏开发 |
| Java 开发 | [路径-Java开发](路径-Java开发.md) | 企业级全栈开发/Spring体系 |
| Rust 开发 | [路径-Rust开发](路径-Rust开发.md) | 系统编程/内存安全/高性能 |
| Python 开发 | [路径-Python开发](路径-Python开发.md) | 数据科学/AI/Web开发/自动化 |
| Dart 开发 | [路径-Dart开发](路径-Dart开发.md) | 移动应用/跨平台/Flutter全栈 |
| 考研 | [路径-考研](路径-考研.md) | 408计算机统考四科系统备考 |
| 渗透测试 | [路径-渗透测试](路径-渗透测试.md) | 网络安全/渗透测试/CTF/红队攻防 |
...
| 数据结构 | [DSA 学习路线](数据结构/DSA学习路线.md) | 21个主题, Phase 0→6, 力扣题目 |
