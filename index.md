...
<p align="center">
  <img src="https://img.shields.io/badge/版本-0.27.0-blue?style=flat-square" alt="version"/>
</p>
...
│ ├── A_数组_Array → V_查找_Search (共22篇，A-V连续编号)
│ ├── C_线性表_LinearList.md 线性表 ADT + 顺序表 + 408 算法设计题
│
