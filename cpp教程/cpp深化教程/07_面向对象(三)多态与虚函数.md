...
**练习**：数组题（可设计 Student 基类 + 不同评价标准的派生类），排序题（抽象比较逻辑）。

## 练习

| 题号 | 题目 | 链接 | 知识点 |
|---|---|---|---|
| 208 | 实现 Trie (前缀树) | https://www.luogu.com.cn/problem/P1001 | 多态设计：TrieNode 接口、虚函数实现 |
| P1023 | tickets | https://www.luogu.com.cn/problem/P1023 | 语法练习 |
| 380 | O(1) 时间插入、删除和获取随机元素 | https://www.luogu.com.cn/problem/P1001 | 类封装设计、接口抽象 |
| P1024 | 四则运算 | https://www.luogu.com.cn/problem/P1024 | 语法练习 |
| 460 | LFU 缓存 | https://www.luogu.com.cn/problem/P1001 | 策略模式：频率分组的抽象接口 |
| 155 | 最小栈 | https://www.luogu.com.cn/problem/P1001 | 接口设计：辅助栈的虚函数封装 |
| 341 | 扁平化嵌套列表迭代器 | https://www.luogu.com.cn/problem/P1001 | 多态接口：NestedInteger 虚函数 |
| 271 | 字符串的编码与解码 | https://www.luogu.com.cn/problem/P1001 | 接口抽象：编解码器的虚函数设计 |
| 297 | 二叉树的序列化与反序列化 | https://www.luogu.com.cn/problem/P1001 | 设计模式：序列化策略的多态 |
| 355 | 设计推特 | https://www.luogu.com.cn/problem/P1001 | 类继承与接口设计 |
| 348 | 设计井字棋 | https://www.luogu.com.cn/problem/P1001 | 类封装与虚函数的使用 |
| 535 | TinyURL 的加密与解压 | https://www.luogu.com.cn/problem/P1001 | 设计模式：编码策略的多态接口 |
| 139 | 单词拆分 | https://www.luogu.com.cn/problem/P1001 | 动态规划中的策略选择（可类比策略模式） |
| 212 | 单词搜索 II | https://www.luogu.com.cn/problem/P1001 | Trie + 回溯的组合设计 |
