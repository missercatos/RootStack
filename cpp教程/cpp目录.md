...
| `04_动态内存` | [[../c语言教程/2深化/03_动态内存管理\|C动态内存管理]] |
| `05_类与对象基础` | [[../c语言教程/2深化/07_面向对象C编程\|C实现OOP]] |
| `13_多线程` | [[../c语言教程/2深化/05_位运算与硬件操作\|C硬件操作]] |
...
| 章节 | 内容 |
|------|------|
| [[容器库/其他/pair.md]] | std::pair 键值对 |
| [[容器库/序列容器/vector.md]] | 动态数组, 随机访问 O(1) |
| [[容器库/序列容器/string.md]] | std::string 字符序列 |
| [[容器库/适配器/stack.md]] | 栈适配器 LIFO |
| [[容器库/适配器/queue.md]] | 队列适配器 FIFO |
| [[容器库/序列容器/deque.md]] | 双端队列 |
| [[容器库/适配器/priority_queue.md]] | 优先队列(堆) |
| [[容器库/序列容器/list.md]] | 双向/单向链表 |
| [[容器库/关联容器/set.md]] | 有序集合(红黑树) |
| [[容器库/关联容器/map.md]] | 有序映射(红黑树) |
| [[容器库/无序容器/unordered_set.md]] | 无序集合(哈希) |
| [[容器库/无序容器/unordered_map.md]] | 无序映射(哈希) |
| [[容器库/其他/bitset.md]] | std::bitset 位集 |
...
| 类型 | 索引文件 | 说明 |
|------|---------|------|
| 容器库 | [[容器库/容器库索引\|容器库索引]] | 序列容器/关联容器/无序容器/适配器/其他 |
| 功能库 | [[cpp功能库/功能库索引\|功能库索引]] | 字符串/IO/算法/数值/并发/内存/函数式/工具 |
| 第三方库 | [[cpp第三方库/第三方库索引\|第三方库索引]] | 网络/GUI/游戏/数据库/序列化/测试/日志/加密/数学/并发/综合 |
...
| 模块 | 入口 |
|------|------|
| 学习路径 | [[../路径B-CPP主线\|C++主线学习路径]] |
| C 到 C++ | [[../路径C-C向下兼容C++.md\|C→C++ 向下兼容路径]] |
| 数据结构与算法 | [[../数据结构/DSA学习路线\|DSA学习路线]] |
| C 语言教程 | [[../c语言教程/c目录\|C语言教程]] |
