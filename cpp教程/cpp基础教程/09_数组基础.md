...
洛谷:
洛谷: [P5722](https://www.luogu.com.cn/problem/P5722) — 数列求和 (循环累加，可用数组存储)
洛谷: [P1427](https://www.luogu.com.cn/problem/P1427) — 小鱼的数字游戏 (数组逆序输出)
洛谷: [P2550](https://www.luogu.com.cn/problem/P2550) — 彩票摇奖 (数组计数)
