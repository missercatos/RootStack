...
在 [[46-容器技术]] 中我们学习了如何使用 Docker 和 Podman 管理单个容器。但当应用规模增长时，单纯使用 `docker run` 会遇到以下瓶颈：
...
- [[46-容器技术]] — Docker 与 Podman 容器核心技术
- [[61-CI-CD基础]] — 持续集成与持续部署基础
- [[48-不可变系统]] — 面向不可变基础设施的系统设计
- [[50-BPF与系统追踪]] — 通过 BPF 理解 K8s 容器网络包流
