...
> Linux 的单体内核架构选择体现了 **实用主义**：虽然微内核在理论上更优雅，但单体内核通过函数调用避免 IPC 开销，获得了更高的性能。内核模块机制又在保持性能的同时提供了模块化能力。详见 [[38-Linux内核基础与模块]]。
...
详见 [[38-Linux内核基础与模块|Linux 内核基础与模块]]。
...
- [[30-进程与线程]] — 了解进程的生命周期与线程模型
- [[10-进程管理]] — 日常进程管理命令与技巧
- [[33-处理机调度]] — CPU 调度算法与 Linux CFS
- [[34-存储管理]] — 物理内存与虚拟内存管理
- [[36-文件系统设计]] — 文件系统原理与 Linux VFS
- [[37-I-O设备管理]] — I/O 子系统与设备驱动
- [[38-Linux内核基础与模块]] — 内核模块深入开发
- [[38-Linux内核基础与模块|Linux 内核基础与模块]] — 从源码编译自定义内核
- [[03-FHS文件系统层次标准|FHS 文件系统层次标准]] — 用户空间基础与 FHS
