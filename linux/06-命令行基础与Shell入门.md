...
>假如linux系统作为日用选择，或者是比赛，自行工作，那么可以自由选择shell,现代shell互相具备兼容性，自行配置之后速度差别不大，主要是使用体验不同，根据自身使用喜好选择即可

>而在企业环境中，比如服务器运维，公司默认系统是linux则以bash居多。
---
...
环境变量是 Shell 中的一个核心概念，在此只介绍基础用法。完整深入讲解（PATH 机制、配置文件加载链、开发工具与系统服务实战）见 [[07-PATH深入与环境变量全书]]；快速查阅 → [[resources/环境变量速查|环境变量速查卡]]；Shell 脚本中的变量高级用法见 [[18-Bash编程基础]]。
...
虽然详细内容在 [[18-Bash编程基础]] 中展开，但以下基础概念需先了解：
...
- [[18-Bash编程基础]] — 深入 Shell 编程
- [[55-终端常用工具大全]] — 提升终端效率的工具集合
