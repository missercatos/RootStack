...
- [[emacs教程/3配置实践/01_配置工程化|配置工程化]]：把键位模块纳入模块化配置并做错误隔离
...
- which-key 项目主页 <https://github.com/justbur/emacs-which-key>（GitHub 在部分网络下需要代理，可用境外访问不便时的替代来源：<https://melpa.org/#/which-key>）；hydra 项目主页 <https://github.com/abo-abo/hydra>；general.el 的 MELPA 页面 <https://melpa.org/#/general>
