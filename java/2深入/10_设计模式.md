...
| 题目 | 链接 | 练习点 |
|------|------|--------|
| [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | lowest-common-ancestor-of-a-binary-tree | 递归分解问题——体会模板方法"定骨架留变化"的递归版 |
| [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | implement-trie-prefix-tree | 用组合方式逐字符挂子节点——组合模式的算法化身 |
