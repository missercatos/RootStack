...
| 题目 | 链接 | 练习点 |
|------|------|--------|
| 两数之和 II | [A+B Problem](https://www.luogu.com.cn/problem/P1001) | 双指针在有序结构中定位，类比在方法表中定位方法 |
| 搜索插入位置 | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | 二分查找边界，理解 getDeclaredMethod 的精确匹配思想 |
| 第一个错误的版本 | [邮票面值设计](https://www.luogu.com.cn/problem/P1021) | 最小化错误调用次数的二分变体 |
