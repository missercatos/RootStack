...
力扣上大量"前 K 个""最接近的""时间区间"题，TreeMap 都是利器。
...
| 题号 | 题目 | 链接 | 知识点 |
|------|------|------|--------|
| 215 | 数组中的第K个最大元素 | https://leetcode.cn/problems/kth-largest-element-in-an-array/ | 堆、优先队列 |
| 347 | 前K个高频元素 | https://leetcode.cn/problems/top-k-frequent-elements/ | HashMap、堆 |
