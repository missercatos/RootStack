...
| 题目 | 链接 | 练习点 |
|------|------|--------|
| LRU 缓存 | [tickets](https://www.luogu.com.cn/problem/P1023) | 先用 LinkedHashMap 五行解，再手写双向链表+HashMap 深刻理解原理 |
| 字母异位词分组 | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | HashMap 分组思想，key 设计是关键（排序串或字符计数串） |
| 前 K 个高频元素 | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | HashMap 统计 + 小顶堆/桶排序两种解法 |
