...
| 题目 | 链接 | 练习点 |
|------|------|--------|
| 按序打印 | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | Semaphore 或 CountDownLatch 控制执行顺序的最简模型 |
| 交替打印 FooBar | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | 两个信号量乒乓交替，wait/notify 版本也值得各写一遍 |
| 生产者消费者简化版 | 参考 [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | 多方协调的 wait/notify 综合，对应本章第九节缓冲区模型 |
