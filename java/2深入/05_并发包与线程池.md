...
| 题目 | 链接 | 练习点 |
|------|------|--------|
| 交替打印 FooBar | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | 两个 Semaphore 乒乓，或两个 Condition 各管一方 |
| 按序打印 | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | 最小化的顺序控制，CountDownLatch 一行解 |
| 打印零与奇偶数 | [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) | 三方协调的综合练习，对应本章 Condition 精确唤醒 |
