...
- [https://www.luogu.com.cn/problem/P1000](P1000 超级玛丽游戏) —— 重点体会 `int` 溢出回绕，判断反转前后是否溢出
- [https://www.luogu.com.cn/problem/P1000](P1000 超级玛丽游戏) —— 反转一半数字进行比较，练习 while 循环与取模
- [https://www.luogu.com.cn/problem/P1000](P1000 超级玛丽游戏) —— char 类型与映射表的结合运用
