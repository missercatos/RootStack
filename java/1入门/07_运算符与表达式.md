...
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 经典 `n & (n-1)` 技巧消除最低位的 1
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 异或的性质：`a^a=0`，全员异或剩答案
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— `n > 0 && (n & (n-1)) == 0`
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 综合练习 `<<`、`>>>`、`&`
