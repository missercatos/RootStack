...
- [四则运算](https://www.luogu.com.cn/problem/P1024) —— 设计一个类封装双栈逻辑，练习成员组织与方法分工
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 类内维护辅助状态，体会封装下不变量的维护
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 数组 + 首尾指针的经典类设计，C 数据结构知识的无缝迁移
