...
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 多条件分支的经典入门题，注意 15 的倍数要先判
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 三边合法性判断（两边之和大于第三边），练习组合条件
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 用闰年判断和月份天数表练习分支逻辑
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 简单分支配合取余运算
