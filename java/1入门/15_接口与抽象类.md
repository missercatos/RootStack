...
- [你的飞碟在这儿](https://www.luogu.com.cn/problem/P1200) —— 用 Deque 接口引用持有实现类，体会面向接口编程
- [tickets](https://www.luogu.com.cn/problem/P1023) —— 综合运用 LinkedHashMap 或手写双向链表 + 哈希的设计题
- [洛谷 P1001 A+B Problem](https://www.luogu.com.cn/problem/P1001) —— 排序后映射下标，练习 Comparator 定制序实战
